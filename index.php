...
<section class="category">
   ...
   <h1 class="title">shop's Available</h1>

   <div class="box-container">

      <a href="category.php?category=SLC-01" class="box">
         <img src="images/store.png" alt="">
         <h3>SLC-01</h3>
      </a>

      <a href="category.php?category=SLC-02" class="box">
         <img src="images/store.png" alt="">
         <h3>SLC-02</h3>
      </a>

      <a href="category.php?category=SLC-03" class="box">
         <img src="images/store.png" alt="">
         <h3>SLC-03</h3>
      </a>
